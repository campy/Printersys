...
//===========================================================================
  ...
  #define BED_CHECK_INTERVAL 100 // ms between checks in bang-bang control  Printersys: Este tiempo gracias a que usamos un rele de estado solido podemos reducirlo
  #if ENABLED(BED_LIMIT_SWITCHING)
    #define BED_HYSTERESIS 0.05 // Only disable heating if T>target+BED_HYSTERESIS and enable heating if T>target-BED_HYSTERESIS
  #endif
#endif
